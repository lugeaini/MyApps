...
public abstract class BaseLibraryFragmentAdapter extends PagerAdapter {
	...
	public BaseLibraryFragmentAdapter(FragmentManager fm) {
		mFragmentManager = fm;
	}
