...
public class PinnedHeaderExpandableListView extends ExpandableListView implements OnScrollListener {
    ...
    public void setOnHeaderUpdateListener(OnHeaderUpdateListener listener) {
        ...
        mHeaderView = mHeaderUpdateListener.getPinnedHeader();
    ...
    protected void refreshHeader() {
        ...
        if (DEBUG) {
            System.out.println("refreshHeader firstVisibleGroupPos=" + firstVisibleGroupPos);
        }

        if (group == firstVisibleGroupPos + 1) {
            View view = getChildAt(1);
            if (view == null) {
                System.out.println("Warning : refreshHeader getChildAt(1)=null");
                return;
            }
