...
import com.chenxulu.library.activity.BaseLibraryFragment;
...
public class MainTabActivity extends AppCompatActivity {
     ...
     */
    public static class PlaceholderFragment extends BaseLibraryFragment {
        /**
        ...
        protected String getLogTag() {
            return super.getLogTag() + section_number;
        }
