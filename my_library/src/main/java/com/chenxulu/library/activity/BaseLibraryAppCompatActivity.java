...
public class BaseLibraryAppCompatActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        log(String.format("onResume(taskId:%d)NativeHeapAllocatedSize:%d, NativeHeapFreeSize:%d", getTaskId(), android.os.Debug.getNativeHeapAllocatedSize(), android.os.Debug.getNativeHeapFreeSize()));
    }
